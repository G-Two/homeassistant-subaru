...
VEHICLE_STATUS_G4 = {
    VEHICLE_STATUS: {
        "AVG_FUEL_CONSUMPTION": 48.2,
        "DISTANCE_TO_EMPTY_FUEL": 210,
        "DOOR_BOOT_POSITION": "CLOSED",
        "DOOR_ENGINE_HOOD_POSITION": "CLOSED",
        "DOOR_FRONT_LEFT_POSITION": "CLOSED",
        "DOOR_FRONT_RIGHT_POSITION": "CLOSED",
        ...
        "TIMESTAMP": datetime.datetime(2024, 1, 2, 12, 20, 15, tzinfo=datetime.UTC),
        "TRANSMISSION_MODE": "UNKNOWN",
        "TYRE_PRESSURE_FRONT_LEFT": 33.5,
        "TYRE_PRESSURE_FRONT_RIGHT": 33.2,
        "TYRE_PRESSURE_REAR_LEFT": 33.8,
        "TYRE_PRESSURE_REAR_RIGHT": 33.6,
        "VEHICLE_STATE_TYPE": "IGNITION_OFF",
